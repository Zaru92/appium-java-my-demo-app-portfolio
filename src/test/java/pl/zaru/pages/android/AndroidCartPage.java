...
public final class AndroidCartPage extends BasePage implements CartPage {
    ...
    private static final By FIRST_PRODUCT_INCREMENT =
        AppiumBy.id(APP_PACKAGE + ":id/plusIV");

    private static final By FIRST_PRODUCT_REMOVE =
        AppiumBy.id(APP_PACKAGE + ":id/removeBt");

    private static final By EMPTY_CART =
        AppiumBy.id(APP_PACKAGE + ":id/noItemCL");
