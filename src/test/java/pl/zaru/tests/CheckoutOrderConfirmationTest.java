...
import pl.zaru.page.OrderConfirmationPageFactory;
import pl.zaru.page.OrderReviewPage;
import pl.zaru.page.OrderReviewPageFactory;
...
public final class CheckoutOrderConfirmationTest extends BaseTest {
    ...
    public void shouldConfirmOrderAfterPlacingIt() {
        ...
        ShippingAddressPage shippingAddressPage =
            ShippingAddressPageFactory.create(driver());

        assertTrue(
            shippingAddressPage.isLoaded(),
            "Shipping address page should be displayed after login.");
        ...
        OrderReviewPage orderReviewPage =
            OrderReviewPageFactory.create(driver());

        assertTrue(
            orderReviewPage.isLoaded(),
            "Order review page should be displayed.");

        orderReviewPage.placeOrder();

        OrderConfirmationPage confirmationPage =
            OrderConfirmationPageFactory.create(driver());
